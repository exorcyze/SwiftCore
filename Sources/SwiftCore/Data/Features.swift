...
mock.set( true, forKey: BoolValues.sampleBool.rawValue )
let feature = Feature( mock )
// OR
Feature.isEnabled( .sampleBool, provider: mock ) // default provider = UserDefaults.standard
*/
...
public extension Feature {
    ...
    ///
    ///   if Feature.isEnabled( .sampleBool ) { }
...
private extension Feature {
    ...
    static func bootstrap<T>( for key: any Featurable ) -> T? {
        ...
        //switch key {
        //case .sampleBool: return features.pbov7Enabled as? T
        //}
        return nil
    }
    ...
    static func bootstrapBool( for key: BoolValues ) -> Bool? {
        ...
        let features = Bootstrap.shared.trackBFeatures
        switch key {
        case .sampleBool: return features.pbov7Enabled
        }
         */
        return nil
    }
